...
/**
 * The 4xx export class of status code is intended for cases in which the client seems
 ...
 * request with a suitable Proxy-Authorization header field (section 14.34).
 ...
 * a suffix of itself), or when the server is under attack by a client
 ...
 * @memberof Koolaid.ErrorHandling.HttpExceptions
 */
export class RequestUriTooLong extends ClientError {
  code = 414;
}
 ...
 * @memberof Koolaid.ErrorHandling.HttpExceptions
 */
export class RequestRangeNotSatisfiable extends ClientError {
  code = 416;
}
